...
- **Time-box gracefully.** When a signal is fully probed (or the candidate clearly doesn't have it), suggest moving on rather than mining further. Clean pivots are good — time is finite.

For `segue (deepen)` nudges, prefer STAR-style follow-ups: "ask what their specific role was on that project", "ask what they personally did", "ask what they'd do differently", "ask for a number".

...
For `segue (deepen)` nudges, prefer concrete, quantifying follow-ups: "ask how often that happens", "ask what they do today", "ask how much time that costs them". For `segue (pivot)`, the strongest bridges are to unasked qualification items (budget, authority, timeline) the prospect just opened a door to — name the bridge.

...
If the Direction states a pacing preference (e.g. "only interrupt if critical" or "jump in often"), that OVERRIDES the default quiet bar — tune how readily you speak up to match it.

...
/**
 * Smoke test for the Agent SDK nudge loop (ported from server/test-fixtures).
 * Spawns the user's `claude` CLI — consumes a small amount of subscription
 * quota. Pass criteria: at least one nudge, no errors, hotkey window yields
 * an "answer"-kind nudge.
 */
